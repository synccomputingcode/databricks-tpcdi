...
dbutils.widgets.text("schema_prefix", "tpcdi_sf", "Target Schema Prefix")
dbutils.widgets.text("scaling_factor", "10", "Scaling Factor")
...
# MAGIC
# MAGIC For the XML portion, install the `com.databricks:spark-xml_2.12:0.16.0` dependency using Maven, according to the [instructions](https://docs.databricks.com/en/libraries/cluster-libraries.html).
# MAGIC
...
folder_path = f"/FileStore/tpc-di/sf{scaling_factor}/Batch1/"
db_schema = f"{schema_prefix}{scaling_factor}"
delimiter = "|"
